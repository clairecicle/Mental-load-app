...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6 font-nunito">
      <div className="w-full max-w-[380px] space-y-8">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <h1 className="mt-4 text-2xl font-bold text-center">Mental Load</h1>
          <p className="mt-2 text-center text-gray-600">Share the mental load with your household</p>
        </div>
